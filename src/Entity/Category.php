...
class Category
{
    ...
    public function getUnclassifable(): ?string
    {
        return $this->unclassifable;
    }

    public function setUnclassifable(string $unclassifable): self
    {
        $this->unclassifable = $unclassifable;
